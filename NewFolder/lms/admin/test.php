                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										?>
											<li><a href="#"><b>Course</b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_quiz.php" class="btn btn-info"><i class="icon-plus-sign"></i> Add Test</a>
									<td width="30"><a href="add_quiz_to_class.php" class="btn btn-success"><i class="icon-plus-sign"></i> Add Test to Class</a></td>   
									</div>
